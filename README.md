A responsive image slider built using HTML, CSS, and JavaScript that allows users to upload their own images and view them in a smooth, automatic slideshow. The slider supports manual navigation as well as auto-play, ensuring a clean and interactive user experience.
